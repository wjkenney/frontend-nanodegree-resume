var bio = {
    ...
    "welcomeMessage": "Here is my bio page, I hope you like it!",
...
var projects = {
    "detail": [{
        "dates": "Feb 2016",
        "title": "tracking ISI-sanitaire merchandice",
        ...
        "images": ["images/lead_large-medium.jpg", "images/lights-medium.jpg"]
    }, {
        "dates": "Feb 2016",
        "title": "tracking collismo package",
    ...
    if (projects.detail !== false) {
        for (var project in projects.detail) {
            if (projects.detail.hasOwnProperty(project)) {
                ...
                var formattedtitle = HTMLprojectTitle.replace("%data%", projects.detail[project].title);
                var formatteddate = HTMLprojectDates.replace("%data%", projects.detail[project].dates);
        ...
        var pictureArray = {
            "images/4-Avian-Flu-medium.jpg": {
                "programs in c": ["https://github.com/wjkenney/dictionary", "https://github.com/wjkenney/server", ]
            },
            "images/lights-medium.jpg": {
                "web based programs": ["https://github.com/wjkenney/cs50-finance", "https://github.com/wjkenney/maps-mashup"]
            },
            "images/lead_large-medium.jpg": {
                "python": ["https://github.com/wjkenney/shortest-path", "https://github.com/wjkenney/virus-modelVirus"]
            }
        };
